        ...
        <div className={`${classes.wrapper}`}>
            ...
            <div className={`${classes.homeContainer} ${styles.container}`}>
                ...
                <div className={classes.imgWrapper}>
                    ...
                    <img src={shapeOne} alt="" className={`${theme === 'lightTheme' ? styles.shapeLight : styles.shape} ${classes.shapeOne}`} />
                    <img src={shapeTwo} alt="" className={`${theme === 'lightTheme' ? styles.shapeLight : styles.shape} ${classes.shapeTwo}`} />
                    <img src={shapeTwo} alt="" className={`${theme === 'lightTheme' ? styles.shapeLight : styles.shape} ${classes.shapeThree}`} />
                </div>
